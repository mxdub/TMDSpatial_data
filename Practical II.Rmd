...
c_boot = list( inv.logit(c_related_param[[1]] %*% t(envt_matrix) - 0.12),
               inv.logit(c_related_param[[2]] %*% t(envt_matrix) - 0.10) )

e_boot = list( inv.logit(e_related_param[[1]] %*% t(envt_matrix) + 1.38),
               inv.logit(e_related_param[[2]] %*% t(envt_matrix) + 0.36) )
...
data_envt = get_envt(sim2)


abundances = sim_to_matrix(sim2)
occupancies = abund_to_occ(abundances)
